...
export default component$<Props>(({ class: className = undefined, label = undefined }) => {
	...
	return (
		...
		>
			<div
				class={[
					"h-50 w-full flex animate-pulse items-center justify-center bg-black/10",
					borderClasses
				]}
			>
			...
			<Button
				...
				class={[
					"absolute right-0 top-0 h-full border-l-0 rounded-l-0 bg-green-200/50 px-4 text-black",
					borderClasses
				]}
				icon={faPenToSquare}
				color={null}
