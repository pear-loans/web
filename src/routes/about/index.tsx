	...
	return (
		<div class="space-y-12">
			<section class="space-y-2">
				...
				<p>
					Unfortunately, this website is still under construction. 🚧 Much of
					the functionality mentioned on the home page is not present. Many
					things, like login, donation pages, and the ability to donate do not
					exist.
				</p>
				<p>
					This project has been created and is currently maintained by one
					person. I'm so excited to create this site, and I very much hope this
					helps reduce someone's financial burden.
				</p>
